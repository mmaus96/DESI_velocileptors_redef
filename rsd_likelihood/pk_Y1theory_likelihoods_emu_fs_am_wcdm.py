...
# from FM_likelihoods.joint_likelihood_gc_emu_am_wcdm_BBspline_redef_multibin_Y1theory_fast import JointLikelihood
...
class abacus_theory_all_rebin_hex(PkLikelihood):
    pass
...
class abacus_theory_LRG1_hex(PkLikelihood):
    pass

class abacus_mock_Y1theory_FS_BAO(JointLikelihood):
    pass

class abacus_mock_Y1theory_FS_BAO_prepre(JointLikelihood):
    pass
