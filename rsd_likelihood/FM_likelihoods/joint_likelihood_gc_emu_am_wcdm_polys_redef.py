...
class JointLikelihood(Likelihood):
    ...
    def initialize(self):
        ...
        self.mpoly_names = [ 'M%d'%(ii) for ii in range(self.npoly)]
        self.qpoly_names = [ 'Q%d'%(ii) for ii in range(self.npoly)]
    ...
    def fs_observe(self,tt,fs_sample_name):
        ...
        # Have to stack ell=0, 2 & 4 in bins of 0.001h/Mpc from 0-k_max h/Mpc.
