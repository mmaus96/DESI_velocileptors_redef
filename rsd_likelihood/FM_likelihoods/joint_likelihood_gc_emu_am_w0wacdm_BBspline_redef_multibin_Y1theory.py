...
#             taylors_xi['derivs_xi2'] = derivs_x2
    ...
    def calculate(self, state, want_derived=True, **params_values_dict):
        ...
        pkclass =  compute_pkclass(cosmopars,wa=True)
        ...
        for zfid,R in zip(self.zfids,self.Rsmooth):
            ...
            rv, xi0table, xi2table,sig8,Dz,fz =compute_xiell_tables(cosmopars, z=zfid, fid_dists= self.fid_dists[zstr], R=R, rmin=60, rmax=160, dr=0.5,pkclass = pkclass,sigs=sigmas,wa=True)
