...
class Taylor_pk_theory_zs(Theory):
    ...
    def calculate(self, state, want_derived=True, **params_values_dict):
        ...
        for zfid in self.zfids:
            ...
            sig8_emu = compute_zpars.compute_sig8([ns,OmM,hub,logA],order = 5)
            Dz_emu = compute_zpars.compute_Dz([ns,OmM,hub,logA],order = 5)
            fz_emu = compute_zpars.compute_fz([ns,OmM,hub,logA],order = 5)
