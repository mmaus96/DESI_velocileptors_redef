...
class Taylor_pk_theory_zs(Theory):
    ...
    def initialize(self):
        ...
        self.Dz = self.compute_theory.fid_class.scale_independent_growth_factor(self.zfids[0])
    ...
    def calculate(self, state, want_derived=True, **params_values_dict):
        ...
        cosmopars = [f_sig8, sig8, apar, aperp,m]
        ...
        for zfid in self.zfids:
            ...
            fsig_s8 = self.compute_theory.compute_fsigma_s8([f_sig8, apar, aperp,m],zfid)
            
            ptables[zstr] = (kv, p0ktable, p2ktable, p4ktable)
            
        #state['sigma8'] = sig8
        state['derived'] = {'fsig_s8': fsig_s8,'sig8_z': self.Dz*sig8}
