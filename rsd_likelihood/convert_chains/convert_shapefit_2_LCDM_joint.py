...
#         
        ...
        self.fiducial_all = [h_fid, Hz_fid, rd_fid, Chiz_fid, Amp_fid, transfer_fid, sigma8_fid]
    ...
    def calculate(self, state, want_derived=False, **params_values_dict):
        ...
        #The fiducial values. 
        h_fid, Hz_fid, rd_fid, Chiz_fid, Amp_fid, transfer_fid, sigma8_fid = self.fiducial_all
