from SF_likelihoods.pk_likelihood_shapefit_cubic_am import PkLikelihood
from SF_likelihoods.pk_likelihood_shapefit_cubic_am_sig8 import PkLikelihood as s8Likelihood
...
class abacus_mock_LRG_hex(s8Likelihood):
    pass
...
class abacus_cutsky_LRG1_hex(PkLikelihood):
    pass

class abacus_mock_LRG_hex_2ndGen(PkLikelihood):
    pass
