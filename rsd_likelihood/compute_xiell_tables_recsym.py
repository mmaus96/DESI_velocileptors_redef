...
def compute_pkclass(pars,wa=False):
...
def compute_xiell_tables(pars, z=0.61, fid_dists= (None,None), R=15., rmin=50, rmax=160, dr=0.1,pkclass = None, sigs = (0.,0.,0.), wa = False):
